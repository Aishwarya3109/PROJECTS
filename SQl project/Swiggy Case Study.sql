...
-- 7.FIND THE RESTAURANTS THAT HAVE AN AVERAGE COST WHICH IS HIGHER THAN THE TOTAL AVERAGE COST OF ALL RESTAURANTS TOGETHER.
...
-- 9.FIND THE TOP 5 MOST EXPENSIVE RESTAURANTS THAT OFFER CUISINE OTHER THAN INDIAN CUISINE
...
select distinct restaurant_name,
(count(case when veg_or_nv ='Veg' then 1 end)*100/
...
select distinct restaurant_name,
(count(case when veg_or_nv='Non-veg' then 1 end)*100
